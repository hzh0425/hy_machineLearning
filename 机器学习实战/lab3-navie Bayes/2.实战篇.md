...
上篇文章[Python3《机器学习实战》学习笔记（四）：朴素贝叶斯基础篇之言论过滤器](https://link.zhihu.com/?target=http%3A//blog.csdn.net/c406495762/article/details/77341116)讲解了朴素贝叶斯的基础知识。本篇文章将在此基础上进行扩展，你将看到以下内容：
...
上篇文章提到过，算法存在一定的问题，需要进行改进。那么需要改进的地方在哪里呢？利用贝叶斯分类器对文档进行分类时，要计算多个概率的乘积以获得文档属于某个类别的概率，即计算 ![[公式]](https://www.zhihu.com/equation?tex=p(w_{0}|1)p(w_{1}|1)p(w_{2}|1)+) 。如果其中有一个概率值为0，那么最后的成绩也为0。我们拿出上一篇文章的截图。
...
![img](https://pic1.zhimg.com/80/v2-6f89d405d2b331befac7a14e48de59d4_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-bafbe4a9a545bfb8bcbd46f78a392978_720w.png)
...
为啥这么改？因为取自然对数了。 ![[公式]](https://www.zhihu.com/equation?tex=log_{ab}+%3D+log_{a}+%2B+log_{b}+)
...
数据我已经为大家准备好了，可以在我的Github上下载： [https://github.com/Jack-Cherish/Machine-Learning/tree/master/Naive%20Bayes/email](https://link.zhihu.com/?target=https%3A//github.com/Jack-Cherish/Machine-Learning/tree/master/Naive%20Bayes/email)
...
![img](https://pic1.zhimg.com/80/v2-de2f985574c3ab8a38263ab30dce3c7c_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-011c21ddda6c3ba127cbd31d80f94af8_720w.png)
...
这部分代码获取：[https://github.com/Jack-Cherish/Machine-Learning/blob/master/Naive%20Bayes/bayes-modify.py](https://link.zhihu.com/?target=https%3A//github.com/Jack-Cherish/Machine-Learning/blob/master/Naive%20Bayes/bayes-modify.py)
...
- 民间教程：[https://www.oschina.net/p/jieba](https://link.zhihu.com/?target=https%3A//www.oschina.net/p/jieba)
- 官方教程：[https://github.com/fxsjy/jieba](https://link.zhihu.com/?target=https%3A//github.com/fxsjy/jieba)

新闻分类数据集我也已经准备好，可以到我的Github进行下载：[https://github.com/Jack-Cherish/Machine-Learning/tree/master/Naive%20Bayes/SogouC](https://link.zhihu.com/?target=https%3A//github.com/Jack-Cherish/Machine-Learning/tree/master/Naive%20Bayes/SogouC)

数据集已经做好分类，分文件夹保存，分类结果如下：

![img](https://pic3.zhimg.com/80/v2-1fc5aa136e76c8003e40947ba69e0a1a_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-9c9abe9f1f60fd0c2f91214c223f8934_720w.png)
...
![img](https://pic2.zhimg.com/80/v2-5892abd57e4173b11755a3a51d7cf7a5_720w.png)
...
官方英文文档地址：[http://scikit-learn.org/dev/modules/generated/sklearn.naive_bayes.MultinomialNB.html](https://link.zhihu.com/?target=http%3A//scikit-learn.org/dev/modules/generated/sklearn.naive_bayes.MultinomialNB.html)
...
![img](https://pic3.zhimg.com/80/v2-2dcc00afbaad8fa475cd98a399a15f6e_720w.png)

对于新闻分类，属于多分类问题。我们可以使用MultinamialNB()完成我们的新闻分类问题。另外两个函数的使用暂且不再进行扩展，可以自行学习。MultinomialNB假设特征的先验概率为多项式分布，即如下式：

![img](https://pic1.zhimg.com/80/v2-74b0348bd0d8aa586bdc3ba6850f1004_720w.png)

其中， ![[公式]](https://www.zhihu.com/equation?tex=P(X_{i}+%3D+X_{jl}+|+Y+%3D+C_{k})) 是第k个类别的第j维特征的第l个取值条件概率。 ![[公式]](https://www.zhihu.com/equation?tex=m_{k}) 是训练集中输出为第k类的样本个数。λ为一个大于0的常数，尝尝取值为1，即拉普拉斯平滑，也可以取其他值。

接下来，我们看下MultinamialNB这个函数，只有3个参数：

![img](https://pic3.zhimg.com/80/v2-78f7455bfca5fc3fa3850de69ef4535e_720w.png)
...
![img](https://pic3.zhimg.com/80/v2-a65d6640420f836f91de10a2e89f23ee_720w.png)

除此之外，MultinamialNB也有一些方法供我们使用：

![img](https://pic1.zhimg.com/80/v2-ae438fee6ee3aec8a710ce4f98a5b724_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-0bfd3553b721c6a2da483253b7a52b18_720w.png)
...
![img](https://pic4.zhimg.com/80/v2-8a39d5574cf5918cdafa7651654b7fe3_720w.png)
